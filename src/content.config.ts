...
const ostali_linkovi = defineCollection({
    loader: glob({base: './src/content/stranice', pattern: '**/ostali-linkovi.md'}),
    schema: () => z.object({
        ostali_linkovi: z.string(),
        najnovije_vesti: z.string(),
        linkovi: z.object({
            ikonica: z.enum(ikonice),
            naslov: z.string(),
            link: z.string(),
